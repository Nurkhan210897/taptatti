    ...
    <div class="info-pay mt-5">
      ...
      <ul>
        <li>
          <p>
            Условие!
            <b>Укажите номер телефон получателя</b> (надо написать)
            Перепроверьте указанный вами выше адрес.
          </p>
        </li>
        <li>
          <p>
            Если принимающий не будет принимать телефон или не будет находиться по адресу доставки, то торт
            <b>к возрату не подлежит</b>, либо отнесем в другое указанное время.
          </p>
        </li>
      </ul>
      <br />
